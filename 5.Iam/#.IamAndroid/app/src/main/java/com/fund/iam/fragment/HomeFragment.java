...
public class HomeFragment extends Fragment {
    ...
    TextView text_job;
    @BindView(R.id.profile_age_location)
    TextView text_age_location;
...
//                Toast.makeText(getActivity(), "ACTION_MEDIA_SCANNER_SCAN_FILE", Toast.LENGTH_SHORT).show();
    ...
    @Optional
    @OnClick({R.id.button_add_text, R.id.button_add_image, R.id.button_get_user, R.id.button_next_user})
...
//        layout.addView(linearLayout);
        ...
        EditText textEdit = (EditText) newLayout.findViewById(R.id.portfolioText_edit);
...
//        LinearLayout layout = (LinearLayout) getView().findViewById(R.id.portfolio_layout);
    ...
    private void getUserList() {
        ...
        retrofitService.getUserList().enqueue(new Callback<List<UserInfo>>() {
            @Override
            public void onResponse(@NonNull Call<List<UserInfo>> call,
                                   @NonNull Response<List<UserInfo>> response) {
                if (response.isSuccessful()) {
                    Log.e(TAG, "======================================");
                    Log.e(TAG, "response.isSuccessful getUserList 출력 시작");
                    ...
                    Log.e(TAG, "response.isSuccessful getUserList 출력 끝");
                    Log.e(TAG, "======================================");
                }
            }
            ...
            public void onFailure(@NonNull Call<List<UserInfo>> call, @NonNull Throwable t) {
                Log.d(TAG, "retrofitService.getUserList onFailure");

                Toast.makeText(getActivity(), "서버를 확인해 주세요.", Toast.LENGTH_SHORT).show();
            }
        });

        Log.d(TAG, "end getUserList");
    }

    private void getUserPortfolio() {
        Log.d(TAG, "getUserPortfolio");

        retrofitService.getPortfolioList().enqueue(new Callback<List<PortfolioInfo>>() {
            @Override
    ...
    private void changeUIUserInfo(UserInfo data) {
        ...
        text_job.setText(data.getNick_name());
        text_age_location.setText(data.getAge() + "세");
